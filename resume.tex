        ...
        \begin{description}
            ...
            \item[\normalfont \textcolor{ColorOne}{Since Jan. 2024}]
                ...
                \begin{itemize}[topsep=0pt]
                    \item Work with a team of AI engineers to \textbf{develop, deploy and monitor ML applications in large-scale context} (AWS EKS/Helm/Terraform/RabbitMQ/FastAPI/Evidently)
                    \item \textbf{Handle MLOps topics} like model versioning, reproducibility, provisioning, CI/CD (make complete switch from Jenkins to GitHub Actions) and \textbf{LLM serving/LLMOps}
