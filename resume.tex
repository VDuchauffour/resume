...
\begin{adjustbox}{valign=t}
    \begin{minipage}{0.6\textwidth}
        ...
        \begin{description}
            \raggedright
            \item[\normalfont \textcolor{ColorOne}{Since Aug. 2025}]
                \textbf{MLOps Engineer - Kolecto}\\
                \small
                \begin{itemize}[topsep=0pt]
                    \item \textbf{Handle MLOps topics} to help data scientists and ML engineers build and deploy ML applications at scale
                \end{itemize}
                \normalsize
            \item[\normalfont \textcolor{ColorOne}{Jan. 2024 -- Jul. 2025}]
            ...
            \item[\normalfont \textcolor{ColorOne}{Sep. 2021 -- Sep. 2022}]
                \textbf{Data Scientist - Yanport} \textit{(Apprenticeship)}\\
                \small
                \begin{itemize}[topsep=0pt]
        ...
        \begin{description}
            ...
            \item [\normalfont \textcolor{ColorOne}{2019 -- 2021}]~\\
                  \textbf{Msc Digital Humanities} - CNAM
        \end{description}
    \end{minipage}
\end{adjustbox}
\end{document}
